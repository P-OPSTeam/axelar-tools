...
echo "active"
docker exec vald sh -c "echo $KEYRING | axelard tx nexus register-chain-maintainer ethereum --from broadcaster --node http://axelar-core:26657 --gas auto --gas-adjustment 1.2"
else 
...
echo "active"
docker exec vald sh -c "echo $KEYRING | axelard tx nexus register-chain-maintainer avalanche --from broadcaster --node http://axelar-core:26657 --gas auto --gas-adjustment 1.2"
else 
...
echo "active"
docker exec vald sh -c "echo $KEYRING | axelard tx nexus register-chain-maintainer fantom --from broadcaster --node http://axelar-core:26657 --gas auto --gas-adjustment 1.2"
else 
...
echo "active"
docker exec vald sh -c "echo $KEYRING | axelard tx nexus register-chain-maintainer moonbeam --from broadcaster --node http://axelar-core:26657 --gas auto --gas-adjustment 1.2"
else 
...
echo "active"
docker exec vald sh -c "echo $KEYRING | axelard tx nexus register-chain-maintainer polygon --from broadcaster --node http://axelar-core:26657 --gas auto --gas-adjustment 1.2"
else 
